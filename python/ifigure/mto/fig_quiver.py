...
#           v, n, FillMode = self.getp(('v', 'n', 'FillMode'))
           ...
           try:
              ...
              logging.exception("FigQuiver:generate_artist : artist generation failed")
...
class FigQuiver3D(FigQuiver, ZUser):
    ...
    def generate_artist(self):
        ...
        ### does not change
           container=self.get_container()
           if container is None: return
           if not self.get_figaxes().get_3d(): return
           flag = 0
           if self.isempty() is False:
              return
...
#           v, n, FillMode = self.getp(('v', 'n', 'FillMode'))
           ...
           try:
              ...
              logging.exception("FigQuiver3D:generate_artist : artist generation failed")
