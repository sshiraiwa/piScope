...
#        self.highlight_artist(False)
        ...
        for t in self._clabels: t.remove()
        self._clabels = []
...
#
    ...
    def _make_clabel_param(self):
        ...
        if not self._clabel_param['fixed_color']: kargs['colors'] = None
    ...
    def get_clabel_param(self, a):
        v =    (self._clabel_param['use_clabel'],
                ...
                (self._clabel_param['fixed_color'], self._clabel_param['colors']),
