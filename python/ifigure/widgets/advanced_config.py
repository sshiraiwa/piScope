...
class AdvancedConfig(PrefComponent):
    ...
    def get_dialoglist(self):
        ...
        list1 = [["Max worker threads number", str(self.setting["max_thread"]), 0, None],
                 ["Text in vector format file", not self.setting["keep_text_as_text"], 3, {"text":"Rasterize Text"}],
                 ["dpi of image in print", str(self.setting["image_dpi"]), 0, None],
                 ["default repository", str(self.setting["hg_default_url"]), 0, None],
